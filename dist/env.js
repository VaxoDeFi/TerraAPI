 ...
 */
export default {
  POSTGRESQL_ADDON_DB: process.env.DOCKER_ENV ? process.env.POSTGRES_DB : process.env.POSTGRESQL_ADDON_DB,
  POSTGRESQL_ADDON_HOST: process.env.DOCKER_ENV ? "postgres" : process.env.POSTGRESQL_ADDON_HOST,
  POSTGRESQL_ADDON_PASSWORD: process.env.DOCKER_ENV ? process.env.POSTGRES_PASSWORD : process.env.POSTGRESQL_ADDON_PASSWORD,
